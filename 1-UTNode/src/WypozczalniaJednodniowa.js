...
class WypozczalniaJednodniowa{ //klasy (definiowane przez slowo kluczowe class)
    ...
    podaj_top10_wypozyczanych = function(){
        var top10 = []
        this.tab.forEach(function(s){
            if(top10.length<10){
                top10.push(s);
    ...
    podaj_top10_uszkadzanych = function(){ //uproszczona skladnie "strzalkowa" dla funkcji anonimowych
        var top10 = []
        this.tab.forEach((s)=>{
            if(top10.length<10){
                top10.push(s);
